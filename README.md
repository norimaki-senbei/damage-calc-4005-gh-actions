...
<!-- バッジ(Badge) という CI ツールのジョブやテストの結果を表示するアイコンを表示 -->
![](https://github.com/norimaki-senbei/damage-calc-4005-gh-actions/workflows/Damage%20Calculation%20Test/badge.svg)